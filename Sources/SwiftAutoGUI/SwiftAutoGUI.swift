// https://github.com/NakaokaRei/SwiftAutoGUI/blob/master/Sources/SwiftAutoGUI/SwiftAutoGUI.swift
...
/// https://github.com/hangj/SwiftAutoGUI/blob/master/Sources/SwiftAutoGUI/Keycode.swift
///
...
public class SwiftAutoGUI {
    ...
    public static func mouseMove(dx: CGFloat, dy: CGFloat) {
    ...
    public static func mouseMove(to: CGPoint) {
    ...
    /// Example
    /// ```
    /// SwiftAutoGUI.copy("hello world")
    /// SwiftAutoGUI.sendKeyShortcut([.command, .v])
    /// ```
...
// SwiftAutoGUI.mouseMove(to: NSPoint(x: 200, y: 200))
// SwiftAutoGUI.leftClick()
// sleep(1)
// SwiftAutoGUI.copy(str: "hello world")
// SwiftAutoGUI.sendKeyShortcut([.command, .v])
